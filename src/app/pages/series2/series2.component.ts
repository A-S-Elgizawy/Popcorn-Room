...
@Component({
  selector: 'app-series2',
  imports: [CommonModule,RouterLink],
  templateUrl: './series2.component.html',
  styleUrl: './series2.component.css'
})
export class Series2Component {
  moviesList: any[] = [];
  movies: any[] = [];
...
getAllmovies(){ 
  ...
  this.movies=this.moviesList.slice(95,99)
