...
@Component({
  selector: 'app-series1',
  imports: [CommonModule,RouterLink],
  templateUrl: './series1.component.html',
  styleUrl: './series1.component.css'
})
export class Series1Component {
  moviesList: any[] = [];
  movies: any[] = [];
...
getAllmovies(){ 
  ...
  this.movies=this.moviesList.slice(90,95)
